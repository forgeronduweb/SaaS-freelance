                    ...
                    <div className="lg:col-span-1">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            <Image 
                                ...
                                className="w-8 h-8"
                            />
                            <span className="text-xl font-bold text-white">afrilance</span>
                        </Link>
                        <p className="text-slate-300 mb-6 leading-relaxed">
                            AfriLance, la première plateforme africaine de freelancing sécurisée via Mobile Money.
                        </p>
                        
                        {/* Icônes de paiement */}
                        <div className="mb-6">
                            <p className="text-sm text-slate-400 mb-3">Paiements sécurisés</p>
                            <div className="flex items-center gap-3">
                                <div className="bg-slate-800 px-3 py-2 rounded text-xs font-medium">
                                    Mobile Money
                                </div>
                                <div className="bg-slate-800 px-3 py-2 rounded text-xs font-medium">
                                    Visa
