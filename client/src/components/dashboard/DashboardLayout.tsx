...
export default function DashboardLayout({ children, userType, userName, userAvatar }: DashboardLayoutProps) {
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center">
              <div className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center">
                <span className="text-orange-600 font-medium text-sm">{userAvatar}</span>
              </div>
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-700">{userName}</p>
                <p className="text-xs font-medium text-gray-500 capitalize">{userType}</p>
              </div>
            </div>
          </div>
        </div>
