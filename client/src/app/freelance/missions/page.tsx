                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 gap-2">
                      ...
                      <div className="text-left sm:text-right">
                        <p className="font-semibold text-orange-600">{mission.budget.toLocaleString()} FCFA</p>
                        <p className="text-sm text-slate-500">{new Date(mission.deadline).toLocaleDateString()}</p>
                      </div>
                    </div>
