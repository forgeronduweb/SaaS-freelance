...
const FreelanceSignup = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (formData.categories.length === 0) {
            setError("Veuillez sélectionner au moins une catégorie de service");
            setIsLoading(false);
            return;
        }
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 disabled:cursor-not-allowed text-white font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-lg transition-colors text-sm sm:text-base flex items-center justify-center"
                        >
                            {isLoading ? (
                                <>
